...
alias betcloud="cd $HOME/code/client/betcloud-backend/betcore && source $HOME/code/client/betcloud-backend/betcore/venv/bin/activate && $HOME/code/client/betcloud-backend/betcore/run.sh"
