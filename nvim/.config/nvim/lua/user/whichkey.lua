...
which_key.add({
  ...
  { "<leader>a", "<cmd>CodeCompanionChat Toggle<cr>", desc = "CodeCompanionChat", nowait = true, remap = false },
  { "<leader>b", "<cmd>:Bufferin<cr>", desc = "Buffers", nowait = true, remap = false },
  ...
  { "<Leader>iw", "<C-w>10><CR>", desc = "Increase Width", nowait = true, remap = false },
  { "<Leader>rw", "<C-w>10<<CR>", desc = "Decrease Width", nowait = true, remap = false },
  { "<Leader>ih", "<C-w>10+<CR>", desc = "Increase Height", nowait = true, remap = false },
  { "<Leader>rh", "<C-w>10-<CR>", desc = "Decrease Height", nowait = true, remap = false },
