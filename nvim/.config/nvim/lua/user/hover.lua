...
vim.keymap.set("n", "gN", function() require("hover").switch("previous") end, {desc = "hover.nvim (previous source)"})
vim.keymap.set("n", "gP", function() require("hover").switch("next") end, {desc = "hover.nvim (next source)"})
